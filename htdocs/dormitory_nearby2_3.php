...
<?php
	...
	if(empty($_GET['Title'])){
		...
		$Title = $_GET['Title'];
		$sql = "SELECT * FROM houses WHERE  Title = '$Title'";
	}
...
?>
<!-- 搜尋特定的課程編號 -->
<form id="form1" name="form2" method="get" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> ">
		<p>房屋類型查詢：
			 <input type="text" name="Title"  id="Title"  >   <!-- 這 id="" 根本沒用= = -->
		</p>
		<p>
